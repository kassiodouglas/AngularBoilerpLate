...
export class SidebarLinksService {
  ...
  links: SidebarLink[] = [
    { link: "", label: "Home", icon: "<i class='fa-solid fa-gauge-high'></i>" },
    {
      links:
        [
          ...
          { link: "dev/module/panel", label: "Panel", icon: "<i class='fa-solid fa-chalkboard'></i>" },
    ...
    { label: "separator" },
    { link: "minha-area", label: "Minhas configurações", icon: "<i class='fa-solid fa-user-gear'></i>" },
